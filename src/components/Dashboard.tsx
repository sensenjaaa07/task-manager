...
import { PriorityBadge, DifficultyBadge, StatusDot, SubjectBadge } from "./shared";
...
export default function Dashboard({ tasks, subjects, onUpdateTask, onNavigate }: Props) {
